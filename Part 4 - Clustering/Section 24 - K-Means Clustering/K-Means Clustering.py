...
for i in range(1, 11): # In range, the upper bound is exclusive
      ...
      # max_iter - The maximum number of iterations there can be to find the final clusters when the K-Means algorithm is running. The default value for this parameter is 300.
