...
# X[y_kmeans == 0, 0] - Plotting the x coordinates of all the observation points that
# belong to cluster 1
# y_kmeans == 0 - Taking the cluster 1, 0 - Specifying the first
# column of dataset X
# X[y_kmeans == 0, 1] - Plotting the y coordinates of all the observation points that
# belong to cluster 1
